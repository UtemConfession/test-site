...
shortDesc:{en:"One of the oldest surviving European architectural remains in Southeast Asia.",
ms:"Salah satu sisa seni bina Eropah tertua yang masih wujud di Asia Tenggara."
},
fullDesc:{en:"Built in 1511, the Porta de Santiago is the only remaining part of the once-massive Portuguese fortress in Melaka. It's a must-visit for history enthusiasts and a classic photo spot located at the foot of St. Paul's Hill.",
...
shortDesc:{en:"Vibrant weekend night market famous for local street food and souvenirs.",
ms:"Pasar malam hujung minggu yang meriah, terkenal dengan makanan jalanan tempatan."
},
fullDesc:{en:"Operating every Friday, Saturday, and Sunday night, Jonker Street transforms into a bustling pedestrian market. It's the best place to sample local delicacies like Nyonya Cendol, chicken rice balls, and shop for unique trinkets.",
...
shortDesc:{en:"The second largest zoo in Malaysia, offering daytime exhibits and a Night Safari.",
ms:"Zoo kedua terbesar di Malaysia, menawarkan pameran siang hari dan Safari Malam."
},
fullDesc:{en:"Located in Ayer Keroh, Zoo Melaka spans 54 acres and houses over 1,200 animals across 215 species. The Night Safari on weekends offers a unique perspective on nocturnal wildlife. Great for a half-day outdoor excursion.",
...
shortDesc:{en:"A scenic 45-minute boat ride along the historic Melaka River.",
ms:"Perjalanan bot selama 45 minit yang indah menyusuri Sungai Melaka yang bersejarah."
},
fullDesc:{en:"Cruise past historic buildings, old godowns, traditional villages like Kampung Morten, and vibrant murals. It is highly recommended to go at sunset or at night when the riverbanks are beautifully illuminated.",
...
shortDesc:{en:"A beautifully preserved Peranakan townhouse showcasing late 19th-century culture.",
ms:"Rumah bandar Peranakan yang dipelihara dengan indah yang mempamerkan budaya akhir abad ke-19."
},
fullDesc:{en:"This museum consists of three beautifully restored houses arranged to look like a typical 19th-century Baba-Nyonya residence. Intricate woodwork, antique furniture, and cultural artifacts provide an immersive glimpse into Peranakan heritage.",
...
shortDesc:{en:"A massive recreational forest ideal for morning jogs, cycling, and picnics.",
ms:"Hutan rekreasi besar yang sesuai untuk berjoging pada waktu pagi, berbasikal dan berkelah."
},
fullDesc:{en:"Surrounded by lush greenery, the Melaka Botanical Garden is an excellent escape from the city. The paved pathways are perfect for running, walking, or renting a bicycle. Look out for the resident monkeys, but remember not to feed them.",
...
shortDesc:{en:"A popular coastal spot known for beautiful sunsets and sand dunes.",
ms:"Tempat pesisir pantai yang popular terkenal dengan matahari terbenam yang indah dan bukit pasir."
},
fullDesc:{en:"Pantai Klebang has undergone massive reclamation, leaving behind picturesque sand dunes (accessible via a walk or ATV). It is extremely popular in the late afternoon for kite flying, strolling, and buying food from the many food trucks parked along the road.",
...
shortDesc:{en:"A fun and quirky interactive museum featuring ghosts and ghouls from various cultures.",
ms:"Muzium interaktif yang menyeronokkan dan pelik yang memaparkan hantu dari pelbagai budaya."
},
fullDesc:{en:"More fun than truly terrifying, the Ghost Museum allows visitors to take creative photos with mannequins and setups of traditional ghosts like the Pontianak, Jiangshi, and western vampires. A good indoor group activity.",
...
shortDesc:{en:"A massive water theme park surrounded by natural forest, perfect for hot days.",
ms:"Taman tema air yang besar yang dikelilingi oleh hutan semula jadi, sesuai untuk hari yang panas."
},
fullDesc:{en:"Features multiple high-speed water slides, a wave pool, and a lazy river. Located very close to UTeM, it's a popular weekend destressing spot for students looking to cool down and have fun with friends.",
...
shortDesc:{en:"An outdoor aerial obstacle course suspended high within the forest canopy.",
ms:"Padang halangan udara luar yang digantung tinggi di dalam kanopi hutan."
},
fullDesc:{en:"Test your physical limits with extreme rope climbing, flying foxes, and balancing acts suspended high up in the trees. Located inside the Melaka Botanical Garden, it requires booking and proper sports attire.",
...
shortDesc:{en:"One of the largest bowling alleys in Malaysia with 52 lanes.",
ms:"Salah satu pusat boling terbesar di Malaysia dengan 52 lorong."
},
fullDesc:{en:"Located near UTeM, MIBC is a world-class bowling center. It is an excellent indoor activity for groups of friends, especially during rainy days. Offers student rates on specific days.",
...
}];if(typeof window!=="undefined"){window.activitiesData=activitiesData;}
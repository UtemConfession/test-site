...
const ucpmUpdates = [
    {
        date: "2026-09-18",
        type: "new",
        title: "Student Marketplace & Services Hub",
        summary: "Launched a dedicated peer-to-peer commerce and student freelance services platform with category filtering, multi-image galleries, and direct Telegram/WhatsApp connections.",
        items: [
            "P2P Marketplace Hub: Dedicated categories for Books, Electronics, and Others with price breakdown and bundle offer support",
            "Student Services Directory: Showcase campus transport (Student Grab), personal shoppers (PS), print runners, and assignment helpers",
            "Interactive Image Modal: Built-in responsive swipeable multi-photo preview modal with safe viewport offsets",
            "Direct Student Connect: 1-tap direct outreach via Telegram (@username) and WhatsApp without middlemen fees"
        ]
    },
    {
        date: "2026-09-16",
        type: "improved",
        title: "E-E-A-T Editorial Methodology & Review Board",
        summary: "Published our comprehensive 4-stage editorial verification lifecycle, multi-faculty review board credentials, and citation framework to elevate academic trust.",
        items: [
            "Formal Editorial Lifecycle: Documented 4-stage pipeline (Monitoring, Primary Drafting, Faculty Cross-Verification, Semi-Annual Audit) on About Us page",
            "Multidisciplinary Review Board: Clear editorial governance by senior scholars across FTMK, FKE, FKEKK, and FTKEE",
            "Institutional Source Citations: All academic metrics and deadlines mapped directly to official UTeM Senat and BPA handbooks",
            "Transparent Takedown & Feedback: Direct cryptographic redaction and editorial contact channels for rapid community corrections"
        ]
    },
    {
        date: "2026-09-14",
        type: "improved",
        title: "Comprehensive Guide Topic Clusters & Semantic Silos",
        summary: "Organized all 15 survival guides into 4 semantic topic clusters with bidirectional contextual cross-links and BreadcrumbList structured data.",
        items: [
            "4 Semantic Pillar Clusters: Academic Survival & Grade Elevation, Campus Mobility & Daily Transit, Campus Living & Student Welfare, and Digital Infrastructure & Administrative Portals",
            "Bidirectional Cross-Linking: Contextual navigation grids at the base of every guide enabling seamless topic exploration without bouncing to root directories",
            "BreadcrumbList Schema: Automated JSON-LD structured metadata on all guide articles for enhanced search engine indexing and site hierarchy display",
            "Responsive Sticky Cluster Index: Quick filter tabs on guides.html to instantly filter guides by subject domain"
        ]
    },
    {
        date: "2026-09-12",
        type: "fixed",
        title: "iOS Safari Background Timer & bfcache Resiliency",
        summary: "Resolved iOS Safari background tab freezing for bus countdowns and academic milestone timers using visibilitychange and pageshow event hooks.",
        items: [
            "Instant Tab Wake Recovery: Re-synchronized countdown intervals immediately upon browser visibilitychange and window focus events",
            "bfcache Restoration: Implemented pageshow event listeners to recalculate delta timestamps when navigating backward or forward in WebKit browsers",
            "Clock Drift Prevention: Replaced naive setInterval incrementers with absolute Date.now() epoch deltas for millisecond-accurate bus tracking",
            "PWA Service Worker Offline Match: Added ignoreSearch flag to offline cache match routines for foolproof PWA asset resolution"
        ]
    },
    {
        date: "2026-09-08",
    ...
    },
    {
        ...
        items: [
            "18 Curated Themes: Added Classic UCPM, Midnight Eclipse, Minimal Monochrome, Sakura Neon, Synthwave 80s, Peach Blossom, Arcade 1984, Dracula Violet, Pastel Mocha, Cyberpunk Cyan, Tokyo Night, Abyssal Blue, Cobalt Blue, Matrix Emerald, Electric Aurora, Sepia Warm Night, and Gothic Ember",

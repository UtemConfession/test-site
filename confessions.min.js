...
function switchSubMode(mode) {
    ...
    if (mode === "text") {
        ...
        if (textSubmissionPanel) {
            ...
            textSubmissionPanel.style.transform = "translateY(6px)";
            requestAnimationFrame(() => {
                textSubmissionPanel.style.opacity = "1";
                textSubmissionPanel.style.transform = "translateY(0)";
            });
        }
        ...
        if (imageSubmissionPanel) {
            ...
            imageSubmissionPanel.style.transform = "translateY(6px)";
            requestAnimationFrame(() => {
                imageSubmissionPanel.style.opacity = "1";
                imageSubmissionPanel.style.transform = "translateY(0)";
            });
        }

...
const part1 = content.split('                <!-- Google AdSense Sidebar Multiplex Unit -->')[0];
const part2 = content.split('                            <p class="telegram-widget-desc"')[1];

const missing = `                <!-- Google AdSense Sidebar Multiplex Unit -->
                ...
                <div class="telegram-widget-card"
                    ...
                    <div class="telegram-widget-left"
                        ...
                        <div class="telegram-widget-info"
                            ...
                            <p class="telegram-widget-desc"`;

fs.writeFileSync('index.html', part1 + missing + part2);

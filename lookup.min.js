...
klebang:{en:"<strong>Route M15 (Pulau Gadong):</strong> Public bus route departing from Melaka Sentral serving Pulau Gadong, passing through Klebang-adjacent districts. Check full coverage maps on <a href='https://bas.my/basmymelaka.php' target='_blank' style='color: var(--accent-gold); font-weight: 600;'>bas.my Melaka</a>.",
...
payaluboh:{en:"<strong>Route M16:</strong> Connects Melaka Sentral to Paya Luboh, serving local communities along the route daily. Detailed schedules available on <a href='https://www.causewaylink.com.my/BAS.MY-Melaka/' target='_blank' style='color: var(--accent-gold); font-weight: 600;'>Causeway Link Melaka</a>.",
...
}};document.addEventListener("DOMContentLoaded",()=>{const destSelect=document.getElementById("melakaDestSelect");const resBox=document.getElementById("lookupResultBox");if(!destSelect||!resBox)return;destSelect.addEventListener("change",()=>{const val=destSelect.value;if(!val||!lookupDetails[val]){resBox.style.display="none";resBox.innerHTML="";return;}const lang=(typeof currentLang!=="undefined"?currentLang:(localStorage.getItem("lang")||"en"));const details=lookupDetails[val];resBox.innerHTML=(details&&details[lang])?details[lang]:(details?details.en:"");resBox.style.display="block";});});
...
const UCPMSidebarHTML = `<!-- Desktop Sidebar Navigation -->
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <a href="about.html" class="nav-item" id="desktopAboutTab" style="text-decoration: none; color: inherit;">
    ...
    <div id="mobileMoreDrawer" class="mobile-drawer-overlay">
        <div class="mobile-drawer-sheet">
            ...
            <div class="mobile-drawer-grid">
                ...
                <a href="about.html" class="drawer-item-btn" style="text-decoration: none; color: inherit;">
                    <svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>
